            ...
            <div class="flex-none w-full max-w-full px-3">
                ...
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <h6 class="mb-2 font-medium text-hijau2">Data Duafa</h6>
                        {{ $duafas->links() }}

                        <div class="grid gap-4 mt-4 md:grid-cols-3">
                            <p><span class="font-semibold text-black">Total Uang Santunan Duafa:</span> Rp.
                                {{ number_format($jumlahBiaya) }}</p>
                        </div>
                    </div>
                                    ...
                                    @foreach ($duafas as $duafa)
                                        <tr>
                                            ...
                                            <td
                                                class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-sm font-semibold leading-tight capitalize text-slate-800">{{ $duafa->nama }}</span>
                                            </td>

                                            <td
                                                class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-sm font-semibold leading-tight capitalize text-slate-800">{{ $duafa->nama_istri ?? '-' }}</span>
                                            </td>
                                            <td
                                                class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-sm font-semibold leading-tight capitalize text-slate-800">{{ $duafa->nama_suami ?? '-' }}</span>
                                            </td>
                                            <td
                                                class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-sm font-semibold leading-tight capitalize 
                                                @if ($duafa->status == 'Duda') text-green-500 
                                                @elseif ($duafa->status == 'Janda') text-orange2 
                                            ...
                                            <td
                                                ...
                                                <span
                                                    class="text-sm font-semibold leading-tight text-slate-800">{{ $duafa->RTWarga->nomor_RT }}</span>
                                            </td>
                                            <td
                                                class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <span class="text-sm font-semibold leading-tight text-slate-800">Rp.
                                                    {{ number_format($duafa->jumlah_uang) }}</span>
                                            </td>

                                            <td class="flex p-2 align-middle border-b gap-x-2">
                                                <a href="{{ route('duafa.detail', $duafa->id_duafa) }}"
                                                ...
                                                <button data-modal-target="popup-modal" data-modal-toggle="popup-modal"
                                                    data-id="{{ $duafa->id_duafa }}"
                                                    data-action-url="{{ route('duafa.delete', ':id') }}"
                                                        ...
                                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                            ...
                                                            <div class="p-4 text-center md:p-5">
                                                                ...
                                                                <div class="flex items-center justify-center">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('duafa.delete', $duafa->id_duafa) }}"
