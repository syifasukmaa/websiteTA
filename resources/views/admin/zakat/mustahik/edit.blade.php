                                ...
                                <form class="grid grid-cols-4 gap-y-10 gap-x-4" method="post"
                                    ...
                                    <div>
                                        ...
                                        <select id="kelompok" name="kelompok"
                                            ...
                                            <option value="duafa" {{ $mustahik->kelompok === 'duafa' ? 'selected' : '' }}>
                                                Duafa</option>
                                            <option value="fakir miskin"
                                                {{ $mustahik->kelompok === 'fakir miskin' ? 'selected' : '' }}>Fakir Miskin
                                            </option>
                                            <option value="fisabilillah"
                                                {{ $mustahik->kelompok === 'fisabilillah' ? 'selected' : '' }}>Fisabilillah
                                            </option>
                                            <option value="mualaf" {{ $mustahik->kelompok === 'mualaf' ? 'selected' : '' }}>
                                                Mualaf</option>
                                            <option value="amilin" {{ $mustahik->kelompok === 'amilin' ? 'selected' : '' }}>
                                                Amilin</option>
                                        </select>
                                    </div>
                                    <div>
